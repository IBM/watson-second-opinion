  ...
  return new Promise((resolve, reject) => {
    discovery.getConfigurations({
      ...
      if (error) {
        ...
        // console.log(data)
        //look for keyword enriched configuration
        var configLen = data.configurations.length;
        for (var i = 0; i < configLen; i++) {
          if (data.configurations[i].name === 'keyword-extraction-config');
          configID = data.configurations[i].configuration_id;
        }
        if (configID === undefined) {
          console.log('error, keyword config not found');
        }
        resolve(configID);
      }
    });      
...
//         console.log(envID)
//         console.log(data.configurations[1].configuration_id)

//         discovery.getConfiguration({
//           environment_id: envID,
//           configuration_id: data.configurations[1].configuration_id,
//         }, function(error, data) {
//           if (error) {
...
//             params.file.conversions = data.conversions;
//             params.file.normalizations = data.normalizations;
//             params.file.enrichments = data.enrichments;
...
//                 console.log('asdfjkajsdkfjklasdfjkjkladfjklasdjfkl')
